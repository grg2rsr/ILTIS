...
#        
#
class Traces_Visualizer(pg.GraphicsLayoutWidget):
    def __init__(self,Main,parent):
        super(Traces_Visualizer,self).__init__()
...
#        self.last_pos = pos # needed for keeping the lines while some are removed or added
    ...
    #                    self.Traces_Inspector_Widget.update_trace(Trace,n)
    #                    self.Traces_Inspector_Widget.traces[n].show()
    #                else:
    
                else:
                    self.traces[n].hide()
    #                if self.Traces_Inspector_exists_flag:
    #                    self.Traces_Inspector_Widget.traces[n].hide()
    #                self.dots[n].hide()
                pass
            pass
