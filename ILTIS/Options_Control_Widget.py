...
class Options_Control_Widget(QtGui.QTabWidget):
    ...
    def make_row(self,row_index,var_name,page,label,kind,choices):
        ...
        for i in range(nFields):
            ...
            if kind[i] == 'path':
                Button = QtGui.QPushButton('select path',parent=input_field)
                input_field_layout.addWidget(Button)
                Button.clicked.connect(self.Main.IO.OpenFileDialog) ### FIXME specify more via a wrapper
